...
// Date        : Thu Feb 15 19:39:23 2018
// Host        : goeders-ssh4 running 64-bit Ubuntu 16.04.3 LTS
// Command     : write_verilog ../ooc/ooc_pci_mini/ooc_pci_mini_synth.v -force
// Design      : pci_mini
...
(* EN_NONE = "0" *) (* EN_RD = "1" *) (* EN_TR = "3" *) 
(* EN_WR = "2" *) (* MEMREAD = "4'b0110" *) (* MEMWRITE = "4'b0111" *) 
(* ST_BUSY = "3'b010" *) (* ST_CFGREAD = "3'b110" *) (* ST_CFGWRITE = "3'b111" *) 
(* ST_IDLE = "3'b000" *) (* ST_MEMREAD = "3'b100" *) (* ST_MEMWRITE = "3'b101" *) 
(* SUBSYSTEM_ID = "16'b0000000000000001" *) (* SUBSYSTEM_VENDOR_ID = "16'b1011111010111110" *) (* VENDOR_ID = "16'b0001000011101110" *) 
(* arb_state1 = "2'b00" *) (* arb_state2 = "2'b01" *) (* machine_flushing = "2'b01" *) 
(* machine_read_filling = "2'b11" *) (* machine_waiting = "2'b00" *) 
