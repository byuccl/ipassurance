...
// Date        : Thu Feb 15 19:35:11 2018
// Host        : goeders-ssh4 running 64-bit Ubuntu 16.04.3 LTS
// Command     : write_verilog ../ooc/ooc_counter/ooc_counter_synth.v -force
// Design      : counter
...
module counter
  ...
  wire \<const1> ;
  wire blink_o;
  wire blink_o_reg_i_1_n_1;
  wire blink_o_reg_i_1_n_2;
  wire blink_o_reg_i_1_n_3;
  ...
  CARRY4 blink_o_reg_i_1
       (.CI(\count_reg[27]_i_1_n_0 ),
        .CO({blink_o_reg_i_1_n_1,blink_o_reg_i_1_n_2,blink_o_reg_i_1_n_3}),
        .CYINIT(\<const0> ),
