...
// Date        : Thu Feb 15 19:34:16 2018
// Host        : goeders-ssh4 running 64-bit Ubuntu 16.04.3 LTS
// Command     : write_verilog ../ooc/ooc_apbctrl/ooc_apbctrl_impl.v -force
// Design      : apbctrl
...
(* ECO_CHECKSUM = "642b8ad5" *) (* NO_IOBUF_INSERTION *) (* asserterr = "0" *) 
(* assertwarn = "0" *) (* ccheck = "1" *) (* debug = "2" *) 
(* enbusmon = "0" *) (* haddr = "2048" *) (* hindex = "1" *) 
(* hmask = "4095" *) (* icheck = "1" *) (* mcheck = "1" *) 
(* nslaves = "16" *) (* pslvdisable = "0" *) 
...
module apbctrl
  ...
  wire [3:0]\NLW_apbx/psel[0]2_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__0_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__10_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__11_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__12_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__13_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__14_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__1_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__2_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__3_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__4_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__5_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__6_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__7_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__8_carry_CO_UNCONNECTED ;
  wire [3:0]\NLW_apbx/psel[0]2_inferred__9_carry_CO_UNCONNECTED ;
  ...
  LUT5 #(
    ...
    \apbi[psel][0]_INST_0 
       (.I0(\apbx/syncrregs.r_reg[p][0][psel_n_0_] ),
        .I1(\syncrregs.r[p][0][cfgsel]_i_1_n_0 ),
  ...
  CARRY4 \apbx/psel[0]2_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]213_out ,\NLW_apbx/psel[0]2_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
  ...
  CARRY4 \apbx/psel[0]2_inferred__0_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]20_out ,\NLW_apbx/psel[0]2_inferred__0_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__10_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]210_out ,\NLW_apbx/psel[0]2_inferred__10_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__11_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]211_out ,\NLW_apbx/psel[0]2_inferred__11_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__12_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]212_out ,\NLW_apbx/psel[0]2_inferred__12_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__13_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]214_out ,\NLW_apbx/psel[0]2_inferred__13_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__14_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]2__3 ,\NLW_apbx/psel[0]2_inferred__14_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__1_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]21_out ,\NLW_apbx/psel[0]2_inferred__1_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__2_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]22_out ,\NLW_apbx/psel[0]2_inferred__2_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__3_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]23_out ,\NLW_apbx/psel[0]2_inferred__3_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__4_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]24_out ,\NLW_apbx/psel[0]2_inferred__4_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__5_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]25_out ,\NLW_apbx/psel[0]2_inferred__5_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__6_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]26_out ,\NLW_apbx/psel[0]2_inferred__6_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__7_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]27_out ,\NLW_apbx/psel[0]2_inferred__7_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__8_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]28_out ,\NLW_apbx/psel[0]2_inferred__8_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \apbx/psel[0]2_inferred__9_carry 
       (.CI(\<const0> ),
        .CO({\apbx/psel[0]29_out ,\NLW_apbx/psel[0]2_inferred__9_carry_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const1> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  LUT6 #(
    ...
    \syncrregs.r[p][0][penable]_i_1 
       (.I0(\apbi[pwrite] ),
        ...
        .I3(\apbi[penable] ),
        .I4(\syncrregs.r[p][0][cfgsel]_i_1_n_0 ),
        .I5(rst),
