...
HD_PWD='/home/jgoeders/ipassurance/base/ahbuart_base/ahbuart_base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log leon3mp.vds -m64 -mode batch -messageDb vivado.pb -notrace -source leon3mp.tcl
