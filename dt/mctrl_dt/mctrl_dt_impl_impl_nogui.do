...
read_design ~/conformal_workspace/mctrl_dt/mctrl_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply

// Set the root module of the top design
set_root_module mctrl -revised

// Add net renaming rules
add_renaming_rule {memi[data][31]} {^memi\[31\]$ memi[data][31]} -Revised -pin
add_renaming_rule {memi[data][30]} {^memi\[30\]$ memi[data][30]} -Revised -pin
add_renaming_rule {memi[data][29]} {^memi\[29\]$ memi[data][29]} -Revised -pin
add_renaming_rule {memi[data][28]} {^memi\[28\]$ memi[data][28]} -Revised -pin
add_renaming_rule {memi[data][27]} {^memi\[27\]$ memi[data][27]} -Revised -pin
add_renaming_rule {memi[data][26]} {^memi\[26\]$ memi[data][26]} -Revised -pin
add_renaming_rule {memi[data][25]} {^memi\[25\]$ memi[data][25]} -Revised -pin
add_renaming_rule {memi[data][24]} {^memi\[24\]$ memi[data][24]} -Revised -pin
add_renaming_rule {memi[data][23]} {^memi\[23\]$ memi[data][23]} -Revised -pin
add_renaming_rule {memi[data][22]} {^memi\[22\]$ memi[data][22]} -Revised -pin
add_renaming_rule {memi[data][21]} {^memi\[21\]$ memi[data][21]} -Revised -pin
add_renaming_rule {memi[data][20]} {^memi\[20\]$ memi[data][20]} -Revised -pin
add_renaming_rule {memi[data][19]} {^memi\[19\]$ memi[data][19]} -Revised -pin
add_renaming_rule {memi[data][18]} {^memi\[18\]$ memi[data][18]} -Revised -pin
add_renaming_rule {memi[data][17]} {^memi\[17\]$ memi[data][17]} -Revised -pin
add_renaming_rule {memi[data][16]} {^memi\[16\]$ memi[data][16]} -Revised -pin
add_renaming_rule {memi[data][15]} {^memi\[15\]$ memi[data][15]} -Revised -pin
add_renaming_rule {memi[data][14]} {^memi\[14\]$ memi[data][14]} -Revised -pin
add_renaming_rule {memi[data][13]} {^memi\[13\]$ memi[data][13]} -Revised -pin
add_renaming_rule {memi[data][12]} {^memi\[12\]$ memi[data][12]} -Revised -pin
add_renaming_rule {memi[data][11]} {^memi\[11\]$ memi[data][11]} -Revised -pin
add_renaming_rule {memi[data][10]} {^memi\[10\]$ memi[data][10]} -Revised -pin
add_renaming_rule {memi[data][9]} {^memi\[9\]$ memi[data][9]} -Revised -pin
add_renaming_rule {memi[data][8]} {^memi\[8\]$ memi[data][8]} -Revised -pin
add_renaming_rule {memi[data][7]} {^memi\[7\]$ memi[data][7]} -Revised -pin
add_renaming_rule {memi[data][6]} {^memi\[6\]$ memi[data][6]} -Revised -pin
add_renaming_rule {memi[data][5]} {^memi\[5\]$ memi[data][5]} -Revised -pin
add_renaming_rule {memi[data][4]} {^memi\[4\]$ memi[data][4]} -Revised -pin
add_renaming_rule {memi[data][3]} {^memi\[3\]$ memi[data][3]} -Revised -pin
add_renaming_rule {memi[data][2]} {^memi\[2\]$ memi[data][2]} -Revised -pin
add_renaming_rule {memi[data][1]} {^memi\[1\]$ memi[data][1]} -Revised -pin
add_renaming_rule {memi[data][0]} {^memi\[0\]$ memi[data][0]} -Revised -pin
add_renaming_rule {memo[address][31]} {^memo$ memo[address][31]} -Revised -pin
...
dofile mctrl_dt/mctrl_dt_impl_impl_nogui_second.do