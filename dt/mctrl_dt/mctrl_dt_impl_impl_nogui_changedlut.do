...
read_design ~/conformal_workspace/mctrl_dt/mctrl_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > mctrl_dt/mctrl_dt_changedlut.log
exit
