...
read_design ~/conformal_workspace/apbctrl_dt/apbctrl_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > apbctrl_dt/apbctrl_dt_changedlut.log
exit
