...
read design ~/conformal_workspace/grethm_dt/grethm_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
add renaming rule ahbmo[hbusreq] "^ahbmo$" "ahbmo[hbusreq]" -Revised -pin
...
add renaming rule ethi[rmii_clk] "^ethi$" "ethi[rmii_clk]" -Revised -pin

dofile grethm_dt/grethm_dt_impl_impl_gui_second.do