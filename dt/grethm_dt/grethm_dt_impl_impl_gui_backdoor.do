...
read design ~/conformal_workspace/grethm_dt/grethm_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report verification -compare_result > grethm_dt/grethm_dt_backdoor.log
