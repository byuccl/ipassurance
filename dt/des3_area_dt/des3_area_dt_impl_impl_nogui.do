...
read_design ~/conformal_workspace/des3_area_dt/des3_area_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile des3_area_dt/des3_area_dt_impl_impl_nogui_second.do