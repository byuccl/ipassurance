...
read design ~/conformal_workspace/ahbuart_dt/ahbuart_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply

// Set the root module of the top design
set root module ahbuart -revised

// Add net renaming rules
add renaming rule uarti[rxd] "^uarti$" "uarti[rxd]" -Revised -pin
add renaming rule uarto[txd] "^uarto$" "uarto[txd]" -Revised -pin
...
dofile ahbuart_dt/ahbuart_dt_impl_impl_gui_second.do