...
read_design ~/conformal_workspace/ahbuart_dt/ahbuart_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > ahbuart_dt/ahbuart_dt_changedlut.log
exit
