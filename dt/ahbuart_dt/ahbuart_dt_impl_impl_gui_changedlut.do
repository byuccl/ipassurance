...
system ""  > ahbuart_dt/ahbuart_dt_changedlut.log
...
// Read in the designs
read design ~/conformal_workspace/ahbuart_dt/ooc_ahbuart_impl.v -Verilog -Golden  -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
read design ~/conformal_workspace/ahbuart_dt/ahbuart_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply

// Set the root module of the top design
set root module ahbuart -revised

// Add net renaming rules
add renaming rule uarti "^uarti$" "uarti[rxd][0]" -Revised -pin
add renaming rule uarto "^uarto$" "uarto[txd][0]" -Revised -pin
...
report verification -compare_result > ahbuart_dt/ahbuart_dt_changedlut.log
