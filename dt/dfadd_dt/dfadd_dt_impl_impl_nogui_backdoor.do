...
read_design ~/conformal_workspace/dfadd_dt/dfadd_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > dfadd_dt/dfadd_dt_backdoor.log
exit
