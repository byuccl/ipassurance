...
read_design ~/conformal_workspace/des3_perf_dt/des3_perf_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > des3_perf_dt/des3_perf_dt_changedlut.log
exit
