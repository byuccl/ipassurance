...
read_design ~/conformal_workspace/lfsr_randgen_dt/lfsr_randgen_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > lfsr_randgen_dt/lfsr_randgen_dt_changedlut.log
exit
