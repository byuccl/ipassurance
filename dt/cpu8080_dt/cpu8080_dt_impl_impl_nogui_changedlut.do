...
read_design ~/conformal_workspace/cpu8080_dt/cpu8080_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > cpu8080_dt/cpu8080_dt_changedlut.log
exit
