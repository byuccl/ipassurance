...
read_design ~/conformal_workspace/mips_16_dt/mips_16_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > mips_16_dt/mips_16_dt_changedlut.log
exit
