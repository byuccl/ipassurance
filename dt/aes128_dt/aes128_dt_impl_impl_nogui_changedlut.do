...
read_design ~/conformal_workspace/aes128_dt/aes128_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > aes128_dt/aes128_dt_changedlut.log
exit
