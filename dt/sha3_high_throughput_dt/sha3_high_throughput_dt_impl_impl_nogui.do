...
read_design ~/conformal_workspace/sha3_high_throughput_dt/sha3_high_throughput_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile sha3_high_throughput_dt/sha3_high_throughput_dt_impl_impl_nogui_second.do