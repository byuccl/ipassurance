...
read_design ~/conformal_workspace/pid_simple_dt/pid_simple_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile pid_simple_dt/pid_simple_dt_impl_impl_nogui_second.do