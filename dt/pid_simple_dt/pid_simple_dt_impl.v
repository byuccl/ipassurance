...
// Date        : Thu Feb 15 12:39:02 2018
// Host        : goeders-ssh4 running 64-bit Ubuntu 16.04.3 LTS
// Command     : write_verilog ../dt/pid_simple_dt/pid_simple_dt_impl.v -force
// Design      : top
...
module top
  ...
  wire [15:0]NLW_pid_simple_0_i_wb_adr_UNCONNECTED;
  ...
  pid_simple pid_simple_0
       (.i_clk(clk_IBUF_BUFG),
        .i_rst(sw_IBUF[0]),
        .i_wb_adr({sw_IBUF[15:2],NLW_pid_simple_0_i_wb_adr_UNCONNECTED[1:0]}),
        .i_wb_cyc(sw_IBUF[1]),
