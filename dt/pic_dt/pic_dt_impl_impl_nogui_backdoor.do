...
read_design ~/conformal_workspace/pic_dt/pic_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > pic_dt/pic_dt_backdoor.log
exit
