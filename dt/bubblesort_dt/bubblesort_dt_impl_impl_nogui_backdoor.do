...
read_design ~/conformal_workspace/bubblesort_dt/bubblesort_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > bubblesort_dt/bubblesort_dt_backdoor.log
exit
