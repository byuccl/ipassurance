...
set rc [catch {
  ...
  set_property ip_repo_paths /home/sean/ipassurance/dt/vga_dt/vga_dt.cache/ip [current_project]
  set_property ip_output_repo /home/sean/ipassurance/dt/vga_dt/vga_dt.cache/ip [current_project]
  add_files -quiet /home/sean/ipassurance/dt/vga_dt/vga_dt.runs/synth_1/top.dcp
