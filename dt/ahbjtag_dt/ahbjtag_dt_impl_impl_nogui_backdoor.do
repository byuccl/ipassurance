...
read_design ~/conformal_workspace/ahbjtag_dt/ahbjtag_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > ahbjtag_dt/ahbjtag_dt_backdoor.log
exit
