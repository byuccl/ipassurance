...
read design ~/conformal_workspace/ahbjtag_dt/ahbjtag_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile ahbjtag_dt/ahbjtag_dt_impl_impl_gui_second.do