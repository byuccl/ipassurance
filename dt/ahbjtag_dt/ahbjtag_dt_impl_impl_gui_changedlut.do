...
read design ~/conformal_workspace/ahbjtag_dt/ahbjtag_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report verification -compare_result > ahbjtag_dt/ahbjtag_dt_changedlut.log
