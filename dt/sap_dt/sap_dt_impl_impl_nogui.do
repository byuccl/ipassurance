...
read_design ~/conformal_workspace/sap_dt/sap_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile sap_dt/sap_dt_impl_impl_nogui_second.do