...
read_design ~/conformal_workspace/sap_dt/sap_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > sap_dt/sap_dt_changedlut.log
exit
