...
read_design ~/conformal_workspace/median_dt/median_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > median_dt/median_dt_changedlut.log
exit
