...
read_design ~/conformal_workspace/median_dt/median_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile median_dt/median_dt_impl_impl_nogui_second.do