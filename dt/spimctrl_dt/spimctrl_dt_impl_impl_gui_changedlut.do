...
read design ~/conformal_workspace/spimctrl_dt/spimctrl_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report verification -compare_result > spimctrl_dt/spimctrl_dt_changedlut.log
