...
--  end component;
  ...
  rstn : in std_ulogic;
    ...
    \spii[miso]\ : in std_ulogic;
    \spii[mosi]\ : in std_ulogic;
    \spii[cd]\ : in std_ulogic;
    \spio[mosi]\ : out std_ulogic;
    \spio[mosioen]\ : out std_ulogic;
    \spio[sck]\ : out std_ulogic;
    \spio[csn]\ : out std_ulogic;
    \spio[cdcsnoen]\ : out std_ulogic;
    \spio[ready]\ : out std_ulogic;
    \spio[initialized]\ : out std_ulogic
    );
  end component;
end;
