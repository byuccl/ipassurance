...
HD_PWD='/home/sean/vivado_workspace/spimctrl_dt/spimctrl_dt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log leon3mp.vdi -applog -m64 -messageDb vivado.pb -mode batch -source leon3mp.tcl -notrace
