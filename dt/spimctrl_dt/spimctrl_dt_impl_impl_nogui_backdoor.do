...
read_design ~/conformal_workspace/spimctrl_dt/spimctrl_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > spimctrl_dt/spimctrl_dt_backdoor.log
exit
