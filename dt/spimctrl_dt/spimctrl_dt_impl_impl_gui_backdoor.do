...
system ""  > spimctrl_dt/spimctrl_dt_backdoor.log
...
read design ~/conformal_workspace/spimctrl_dt/spimctrl_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
add renaming rule spii "^spii$" "spii[miso][0]" -Revised -pin
...
report verification -compare_result > spimctrl_dt/spimctrl_dt_backdoor.log
