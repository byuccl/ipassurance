...
read_design ~/conformal_workspace/ahbctrl_dt/ahbctrl_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > ahbctrl_dt/ahbctrl_dt_backdoor.log
exit
