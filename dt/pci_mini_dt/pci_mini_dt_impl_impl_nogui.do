...
read_design ~/conformal_workspace/pci_mini_dt/pci_mini_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile pci_mini_dt/pci_mini_dt_impl_impl_nogui_second.do