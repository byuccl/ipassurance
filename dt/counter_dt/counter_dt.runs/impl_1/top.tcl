...
set rc [catch {
  ...
  set_property ip_repo_paths /home/sean/vivado_workspace/counter_dt/counter_dt.cache/ip [current_project]
  set_property ip_output_repo /home/sean/vivado_workspace/counter_dt/counter_dt.cache/ip [current_project]
  add_files -quiet /home/sean/vivado_workspace/counter_dt/counter_dt.runs/synth_1/top.dcp
