...
read_design ~/conformal_workspace/wb_lcd_dt/wb_lcd_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
dofile wb_lcd_dt/wb_lcd_dt_impl_impl_nogui_second.do