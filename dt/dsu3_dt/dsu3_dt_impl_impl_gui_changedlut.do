...
read design ~/conformal_workspace/dsu3_dt/dsu3_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report verification -compare_result > dsu3_dt/dsu3_dt_changedlut.log
