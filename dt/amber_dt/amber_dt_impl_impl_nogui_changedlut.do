...
read_design ~/conformal_workspace/amber_dt/amber_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > amber_dt/amber_dt_changedlut.log
exit
