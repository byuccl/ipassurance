...
read_design ~/conformal_workspace/amber_dt/amber_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > amber_dt/amber_dt_backdoor.log
exit
