...
read_design ~/conformal_workspace/irqmp_dt/irqmp_dt_impl.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
add_renaming_rule {irqi[0][intack]} {^irqi$ irqi[0][intack]} -Revised -pin

dofile irqmp_dt/irqmp_dt_impl_impl_nogui_second.do