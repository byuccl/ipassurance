...
system ""  > irqmp_dt/irqmp_dt_changedlut.log
...
read design ~/conformal_workspace/irqmp_dt/irqmp_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report verification -compare_result > irqmp_dt/irqmp_dt_changedlut.log
