...
read_design ~/conformal_workspace/irqmp_dt/irqmp_dt_impl_changedlut.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > irqmp_dt/irqmp_dt_changedlut.log
exit
