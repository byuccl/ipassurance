...
--  end component; 
  ...
  \irqi[0][intack]\ : in std_ulogic;
  \irqi[0][irl]\ : in std_logic_vector(3 downto 0);
  \irqi[0][pwd]\ : in std_ulogic;
  \irqi[0][fpen]\ : in std_ulogic;
  \irqi[0][err]\ : in std_ulogic;
  \irqi[1][intack]\ : in std_ulogic;
  \irqi[1][irl]\ : in std_logic_vector(3 downto 0);
  \irqi[1][pwd]\ : in std_ulogic;
  \irqi[1][fpen]\ : in std_ulogic;
  \irqi[1][err]\ : in std_ulogic;
  \irqi[2][intack]\ : in std_ulogic;
  \irqi[2][irl]\ : in std_logic_vector(3 downto 0);
  \irqi[2][pwd]\ : in std_ulogic;
  \irqi[2][fpen]\ : in std_ulogic;
  \irqi[2][err]\ : in std_ulogic;
  \irqi[3][intack]\ : in std_ulogic;
  \irqi[3][irl]\ : in std_logic_vector(3 downto 0);
  \irqi[3][pwd]\ : in std_ulogic;
  \irqi[3][fpen]\ : in std_ulogic;
  \irqi[3][err]\ : in std_ulogic;
  \irqo[0][irl]\ : out std_logic_vector(3 downto 0);
  \irqo[0][resume]\ : out std_ulogic;
  \irqo[0][rstrun]\ : out std_ulogic;
  \irqo[0][rstvec]\ : out std_logic_vector(31 downto 12);
  \irqo[0][index]\ : out std_logic_vector(3 downto 0);
  \irqo[0][pwdsetaddr]\ : out std_ulogic;
  \irqo[0][pwdnewaddr]\ : out std_logic_vector(31 downto 2);
  \irqo[0][forceerr]\ : out std_ulogic;
  \irqo[0][svtclrtt]\ : out std_ulogic;
  \irqo[1][irl]\ : out std_logic_vector(3 downto 0);
  \irqo[1][resume]\ : out std_ulogic;
  \irqo[1][rstrun]\ : out std_ulogic;
  \irqo[1][rstvec]\ : out std_logic_vector(31 downto 12);
  \irqo[1][index]\ : out std_logic_vector(3 downto 0);
  \irqo[1][pwdsetaddr]\ : out std_ulogic;
  \irqo[1][pwdnewaddr]\ : out std_logic_vector(31 downto 2);
  \irqo[1][forceerr]\ : out std_ulogic;
  \irqo[1][svtclrtt]\ : out std_ulogic;
  \irqo[2][irl]\ : out std_logic_vector(3 downto 0);
  \irqo[2][resume]\ : out std_ulogic;
  \irqo[2][rstrun]\ : out std_ulogic;
  \irqo[2][rstvec]\ : out std_logic_vector(31 downto 12);
  \irqo[2][index]\ : out std_logic_vector(3 downto 0);
  \irqo[2][pwdsetaddr]\ : out std_ulogic;
  \irqo[2][pwdnewaddr]\ : out std_logic_vector(31 downto 2);
  \irqo[2][forceerr]\ : out std_ulogic;
  \irqo[2][svtclrtt]\ : out std_ulogic;
  \irqo[3][irl]\ : out std_logic_vector(3 downto 0);
  \irqo[3][resume]\ : out std_ulogic;
  \irqo[3][rstrun]\ : out std_ulogic;
  \irqo[3][rstvec]\ : out std_logic_vector(31 downto 12);
  \irqo[3][index]\ : out std_logic_vector(3 downto 0);
  \irqo[3][pwdsetaddr]\ : out std_ulogic;
  \irqo[3][pwdnewaddr]\ : out std_logic_vector(31 downto 2);
  \irqo[3][forceerr]\ : out std_ulogic;
  \irqo[3][svtclrtt]\ : out std_ulogic
  );
  end component; 
