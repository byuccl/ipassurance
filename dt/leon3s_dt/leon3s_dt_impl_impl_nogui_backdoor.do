...
read_design ~/conformal_workspace/leon3s_dt/leon3s_dt_impl_backdoor.v -Verilog -Revised -Replace -sensitive -continuousassignment Bidirectional -nokeep_unreach -nosupply
...
report_verification -compare_result > leon3s_dt/leon3s_dt_backdoor.log
exit
