...
add_cells_to_pblock [get_pblocks pblock_bcd_adder_0] [get_cells bcd_adder_0]
resize_pblock [get_pblocks pblock_bcd_adder_0] -add {SLICE_X52Y0:SLICE_X57Y12}
set_property CONTAIN_ROUTING true [get_pblocks pblock_bcd_adder_0]
set_property HD.PARTPIN_RANGE {SLICE_X52Y0:SLICE_X57Y12} [get_pins bcd_adder_0/*]
