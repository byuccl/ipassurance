...
add_cells_to_pblock [get_pblocks pblock_amber_0] [get_cells amber_0]
...
set_property CONTAIN_ROUTING true [get_pblocks pblock_amber_0]
set_property HD.PARTPIN_RANGE {SLICE_X12Y8:SLICE_X77Y94} [get_pins amber_0/*]
