...
add_cells_to_pblock [get_pblocks pblock_apbctrl_0] [get_cells apbctrl_0]
...
set_property CONTAIN_ROUTING true [get_pblocks pblock_apbctrl_0]
set_property HD.PARTPIN_RANGE {SLICE_X60Y146:SLICE_X89Y199} [get_pins apbctrl_0/*]; # This is the successful placement
# set_property HD.PARTPIN_RANGE {SLICE_X58Y146:SLICE_X89Y199} [get_pins apbctrl_0/*]; # This causes unrouteable nets in the top impl
