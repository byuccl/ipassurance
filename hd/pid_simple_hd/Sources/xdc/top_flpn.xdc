...
add_cells_to_pblock [get_pblocks pblock_pid_simple_0] [get_cells pid_simple_0]
...
set_property CONTAIN_ROUTING true [get_pblocks pblock_pid_simple_0]
set_property HD.PARTPIN_RANGE {SLICE_X2Y8:SLICE_X27Y36} [get_pins pid_simple_0/*]
...
#set_property PACKAGE_PIN K17 [get_ports {Qspid_simpleB[0]}]       
  #set_property IOSTANDARD LVCMOS33 [get_ports {Qspid_simpleB[0]}]
##Bank = CONFIG, Pin name = IO_L1N_T0_D01_DIN_14,     Sch name = QSPI_DQ1
#set_property PACKAGE_PIN K18 [get_ports {Qspid_simpleB[1]}]       
  #set_property IOSTANDARD LVCMOS33 [get_ports {Qspid_simpleB[1]}]
##Bank = CONFIG, Pin name = IO_L20_T0_D02_14,       Sch name = QSPI_DQ2
#set_property PACKAGE_PIN L14 [get_ports {Qspid_simpleB[2]}]       
  #set_property IOSTANDARD LVCMOS33 [get_ports {Qspid_simpleB[2]}]
##Bank = CONFIG, Pin name = IO_L2P_T0_D03_14,       Sch name = QSPI_DQ3
#set_property PACKAGE_PIN M14 [get_ports {Qspid_simpleB[3]}]       
  #set_property IOSTANDARD LVCMOS33 [get_ports {Qspid_simpleB[3]}]
