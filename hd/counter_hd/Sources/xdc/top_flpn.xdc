...
add_cells_to_pblock [get_pblocks pblock_counter_0] [get_cells counter_0]
...
set_property CONTAIN_ROUTING true [get_pblocks pblock_counter_0]
set_property HD.PARTPIN_RANGE {SLICE_X52Y60:SLICE_X79Y89} [get_pins counter_0/*]
...
set_property PACKAGE_PIN T8 [get_ports {blink_o_top}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {blink_o_top}]
