create_pblock pblock_pid_0
add_cells_to_pblock [get_pblocks pblock_pid_0] [get_cells pid_0]
resize_pblock [get_pblocks pblock_pid_0] -add {SLICE_X2Y8:SLICE_X27Y36 DSP48_X0Y4:DSP48_X0Y13 RAMB18_X0Y4:RAMB18_X0Y13 RAMB36_X0Y2:RAMB36_X0Y6}
set_property CONTAIN_ROUTING true [get_pblocks pblock_pid_0]
set_property HD.PARTPIN_RANGE {SLICE_X2Y8:SLICE_X27Y36} [get_pins pid_0/*]
...
#set_property PACKAGE_PIN U8 [get_ports {CNTstart}]         
# set_property IOSTANDARD LVCMOS33 [get_ports {CNTstart}]
##Bank = 34, Pin name = IO_L23P_T3_34,            Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {MSen}]         
# set_property IOSTANDARD LVCMOS33 [get_ports {MSen}]
