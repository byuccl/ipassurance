...
add_cells_to_pblock [get_pblocks pblock_pci_mini_0] [get_cells pci_mini_0]
...
set_property CONTAIN_ROUTING true [get_pblocks pblock_pci_mini_0]
set_property HD.PARTPIN_RANGE {SLICE_X2Y5:SLICE_X17Y27} [get_pins pci_mini_0/*]
